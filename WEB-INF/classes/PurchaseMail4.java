...
public class PurchaseMail4 extends HttpServlet
{
    ...
    {    
        ...
        String msg="Hi, You have purchased item 4 successfully from 'Agri'gate..\n Have a blast!!!";  
        String p4=request.getParameter("PHONE_NO4");
        //DBLogic
        try
        {
